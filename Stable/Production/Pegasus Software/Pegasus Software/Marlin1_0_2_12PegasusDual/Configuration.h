...
#define STRING_CONFIG_H_AUTHOR "(MakerFarm,12 Pegasus Dual)" // Who made the changes.
...
//#define EXTRUDER_OFFSET_X {0.0, 25.00} // (in mm) for each extruder, offset of the hotend on the X axis
